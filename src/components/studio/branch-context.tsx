    ...
    <section className="context-panel" aria-labelledby="branch-context-title">
      <div className="context-title">
        <div>
          ...
          <h2 id="branch-context-title">What this path carries</h2>
        </div>
        <span>v{props.branch.version}</span>
      </div>
      ...
      <div className="context-band inherited">
        ...
        <div>
          ...
          <small>
            Stable source: {props.branch.baseWorldRevisionId}
      ...
      <div className="context-section changed">
        <div className="context-section-heading">
          <div>
            ...
            <strong>Changed in this branch</strong>
          </div>
          ...
          <form className="context-form" onSubmit={addRule}>
            ...
            <label>
              ...
              <select name="category" defaultValue="world_rule">
                ...
                <option value="character_knowledge">Character knowledge</option>
          ...
          <div className="change-list">
            {props.branch.addedCharacters.map((character) => (
              <article
                key={character.id}
                className={
                  props.agentTargetIds.has(character.id) ? "agent-applied" : ""
                }
              >
      ...
      <div className="context-section locked">
        <div className="context-section-heading">
          <div>
            ...
            <strong>Locked constraints</strong>
          </div>
          <button
            type="button"
        ...
        <ul className="lock-list">
          ...
          {props.branch.constraints.map((constraint) => (
            <li
              key={constraint.id}
              className={
                props.agentTargetIds.has(constraint.id) ? "agent-applied" : ""
              }
            >
              <div>
                <strong>{constraint.label}</strong>
